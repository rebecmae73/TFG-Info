...
class MNISTCached(FashionMNIST):
    """
...
DATA_DIR = os.path.join(EXAMPLE_DIR, "TFG INFO/data")
RESULTS_DIR = os.path.join(EXAMPLE_DIR, "TFG INFO/good_vae_fashion/fashion/results")